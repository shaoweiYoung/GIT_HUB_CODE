...
# 拟合一元三次函数到数据
popt, pcov = curve_fit(cubic_function, x_filtered, y_filtered)

# 计算拟合值
y_fit = cubic_function(x_filtered, *popt)
...
y_fit_curve = cubic_function(x_fit, *popt)
plt.plot(x_fit, y_fit_curve, color='red', label='Fitted cubic function')
