...
# 输入裁剪目标文件夹路径
target_folder = "F:/research data/studies of fagaceae/aok/fagaceae/oak/oak GISpro/the process date/pythgon fishnet/30mall_0.51.0"
...
for root, dirs, files in os.walk(target_folder):
    for file in files:
        if file.endswith('.shp'):
            if file == 'fishnet_986.shp':  # 设置从第266个文件开始裁剪
                clip_started = True
